...
public class Cobrar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Producto", "Partida", "K Etiqueta", "# Piezas", "Costo", "Cantidad", "Precio Venta", "Total"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      if(new mVentas().update(jTextField4.getText(),data.get(0).toString())){
      JOptionPane.showMessageDialog(null,"Cobrado correctamente");
      new Menu();
      this.dispose();
      }else{
...
private void llenar(){
jTextField1.setText(data.get(1).toString());//Fecha
jTextField2.setText(data.get(2).toString());//Cliente
jTextField3.setText(data.get(4).toString());//chofer
jLabel5.setText(data.get(3).toString());//Usuario
jLabel7.setText(data.get(5).toString());//Usuario
