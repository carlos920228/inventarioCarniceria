...
public class ReporteConversiones extends javax.swing.JFrame {
    DefaultTableModel tabla;
    public ReporteConversiones() {
        initComponents();
        Image f= Toolkit.getDefaultToolkit().
        getImage(ClassLoader.getSystemResource("image/caba_1.png"));
        this.setIconImage(f);
        setTitle("Transformaciones realizadas");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Producto", "Cantidad", "Fecha", "Motivo"
            }
        ) {
...
ArrayList data=new mConversion().data();
for(Object o:data){
ArrayList c=(ArrayList)o;
tabla.addRow(c.toArray());
}
}
