...
public class ReporteVentas extends javax.swing.JFrame {
    ...
    public ReporteVentas() {
        ...
        loadTable(new mVentas().listSale());
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Folio", "Fecha", "Cliente", "Usuario", "Repartidor", "Total", "Estatus", "Descuento"
            }
        ) {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pagado", "pendiente", "Todas" }));

        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/pesos.png"))); // NOI18N
...
private ArrayList loadData() {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        reset();
        loadTable(new mVentas().listSale(data.get(0).toString(), data.get(1).toString(),jComboBox1.getSelectedItem().toString()));
